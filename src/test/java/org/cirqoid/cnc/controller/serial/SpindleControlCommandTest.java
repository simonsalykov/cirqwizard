 ...
 */
public class SpindleControlCommandTest
{

    @Test
    public void testSerialization()
    {
        SpindleControlCommand command = new SpindleControlCommand(1000);
        command.setId(12345);
        ...
        // CRC
        assertEquals((byte) 0xD3, p[18]);
        assertEquals((byte) 0x9C, p[19]);
        assertEquals((byte) 0x1A, p[20]);
        assertEquals((byte) 0xA6, p[21]);
    }
