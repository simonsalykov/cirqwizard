 ...
 */
public class G1Command implements org.cirqoid.cnc.controller.interpreter.commands.Command
{
    @Override
    ...
    {
        interpreter.setCurrentInterpolationMode(Context.InterpolationMode.LINEAR);
        return null;
    }
}
